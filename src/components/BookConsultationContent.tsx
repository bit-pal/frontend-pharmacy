          ...
          {currentStep === 2 && (
            <>
              ...
              <div className="grid grid-cols-2 gap-8 mb-8">
                {/* Calendar */}
                <div>
                  {/* Month Navigation - positioned over calendar */}
                  <div className="flex justify-end mb-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <h3 className="text-base font-semibold text-gray-900 min-w-[120px] text-center">
                  ...
                  <div className="grid grid-cols-7 gap-1">
                    ...
                    {Array.from({ length: getDaysInMonth(currentMonth, currentYear) }, (_, i) => i + 1).map(date => (
                      <button
                        ...
                        className={`p-3 text-center text-sm border-b-2 hover:bg-gray-100 transition-colors ${
                          selectedDate === date ? 'border-gray-800 bg-gray-100 font-semibold' : 'border-gray-300'
                        }`}
                      >
                        {date}
                      </button>
                ...
                <div>
                  ...
                  {selectedDate ? (
                    ...
                    <div className="bg-gray-100 rounded-lg p-8 text-center h-80 flex items-center justify-center">
                      <p className="text-pink-500 text-base">Select date</p>
                    </div>
                  )}
                </div>
              </div>
          ...
          {currentStep === 3 && (
            <div className="flex justify-between mt-8">
              ...
              <button 
                ...
                className="bg-pink-500 hover:bg-pink-600 text-white font-medium px-6 py-2 rounded transition-colors duration-200"
              >
                CONFIRM BOOKING
              </button>
            </div>
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center space-x-4">
                  <a 
                    ...
                    className="flex flex-col items-center px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg transition-colors duration-200 no-underline text-xs"
                  >
                    <svg className="w-5 h-5 mb-1 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <button className="flex flex-col items-center px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg transition-colors duration-200 text-xs">
                    <svg className="w-5 h-5 mb-1 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                    </svg>
                  ...
                  <button 
                    ...
                    className="flex flex-col items-center px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg transition-colors duration-200 text-xs"
                  >
                    <svg className="w-5 h-5 mb-1 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
