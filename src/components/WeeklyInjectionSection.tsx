...
export default function WeeklyInjectionSection() {
  return (
    <div className="bg-white rounded-2xl p-8 shadow-sm border">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col h-full bg-gray-100 p-4 rounded-lg">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2.5 rounded-lg transition-colors w-full text-sm mt-4">
            Get Started →
          </button>
        </div>

        {/* Right - Dedicated Mounjaro Support */}
        <div className="flex flex-col h-full bg-gray-100 p-4 rounded-lg">
          <div className="flex-grow">
            <h4 className="text-xl font-bold text-black mb-4">
              Dedicated Mounjaro Support
            </h4>
            <p className="text-gray-600 text-sm mb-4">
