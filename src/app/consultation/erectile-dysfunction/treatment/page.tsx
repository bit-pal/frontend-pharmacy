          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="lg:w-80 flex flex-col items-center">
                <div className="w-64 h-48 relative mb-4 bg-gray-50 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-gray-300">Viagra</div>
                ...
                <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg flex items-center justify-center">
                  Buy Now
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="lg:w-80 flex flex-col items-center">
                <div className="w-64 h-48 relative mb-4 bg-gray-50 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-gray-300">Cialis</div>
                    <div className="text-sm text-gray-400">Product Image</div>
                  </div>
                </div>
                <div className="text-center mb-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="lg:w-80 flex flex-col items-center">
                <div className="w-64 h-48 relative mb-4 bg-gray-50 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-gray-300">Spedra</div>
                    <div className="text-sm text-gray-400">Product Image</div>
                  </div>
                </div>
                <div className="text-center mb-4">
