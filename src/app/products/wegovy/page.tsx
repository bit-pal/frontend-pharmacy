...
export default function WegovyProductPage() {
  const [selectedStrength, setSelectedStrength] = useState('2.4mg');
  ...
  const strengths = [
    { value: '0.25mg', label: 'Semaglutide' },
    { value: '0.5mg', label: 'Semaglutide' },
    { value: '1mg', label: 'Semaglutide' },
    { value: '1.7mg', label: 'Semaglutide' },
    { value: '2.4mg', label: 'Semaglutide' }
  ];
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-200 rounded-2xl p-8 flex flex-col items-center justify-center">
              ...
              <div className="mt-8 text-center">
                <h1 className="text-3xl font-bold text-gray-900 mb-4">Wegovy weight loss treatment plan</h1>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-8">
              ...
              {/* Price */}
              <div className="mb-6">
                <div className="text-3xl font-bold text-teal-600 mb-1">£139.95</div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-gray-200">
                <div>
                  ...
                  <p className="font-bold text-gray-900">Around 15%</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-bold text-gray-900">From £61.25 per week</p>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                <p className="text-sm text-gray-700">
                  Please be aware that due to supply constraints, we cannot guarantee consistent availability to
                  fulfill all treatment plans. Should you wish to discuss the Wegovy treatment plan further, please
          ...
          <div className="space-y-4">
              ...
              {expandedSection === 'what' && (
                <div className="px-6 pb-6">
                  <p className="text-gray-700 mb-4">
                    Wegovy is designed to support your weight loss journey on a weekly basis. Enhanced by a balanced, calorie-conscious diet and regular physical activity, Wegovy maximises its effectiveness, ensuring safe and steady weight loss progress.
                  </p>
                  ...
                  <p className="text-gray-700">
                    Wegovy works by slowing down how fast food moves through your stomach after eating. This can lead to you feeling fuller for longer and in turn reduces your appetite. Alongside diet and exercise this can lead to you losing weight.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-gray-50 rounded-lg">
              <button
                ...
                className="w-full flex items-center justify-between p-6 text-left"
              >
                <span className="text-lg font-semibold text-gray-900">Using Wegovy</span>
                <span className="text-2xl text-gray-600">{expandedSection === 'using' ? '−' : '+'}</span>
              </button>
              {expandedSection === 'using' && (
                <div className="px-6 pb-6">
                  <p className="text-gray-700 mb-4">
                    Administer Wegovy via injection once weekly into your abdomen, thigh, or upper arm. Tailored to your treatment stage, Wegovy is available in various doses.
                  </p>
                  <p className="text-gray-700 mb-4">
                    Commencing with a 0.25mg initial dose, subsequent increments are administered until reaching 2.4mg. This gradual dosage escalation ensures manageable adaptation to any potential side effects. Each dosage level is maintained for four weeks before advancing to the next.
                  </p>
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    <li>Read the Instructions for Use that come with Wegovy.</li>
                    <li>Use Wegovy exactly as your healthcare provider says.</li>
                  ...
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    ...
                    <li>Use Wegovy on the same day each week.</li>
                    <li>To help you remember, when to use Wegovy, you may wish to tick the day of the week when you inject your first dose on the box that your pen comes in, or mark it on a calendar.</li>
            ...
            <div className="bg-gray-50 rounded-lg">
              ...
              {expandedSection === 'side' && (
                <div className="px-6 pb-6">
                  <p className="text-gray-700 mb-4">
                    As with any medication, certain individuals may experience side effects while using Wegovy. Some very common side effects may include:
                  </p>
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    <li>Nausea</li>
                    <li>Vomiting</li>
                  ...
                  <p className="text-gray-700 mb-4">
                    The side effects of Wegovy typically improve over time as your body adjusts to the treatment. You may find that side effects are most noticeable during the dose escalation phase and tend to be mild. As your body acclimates to the treatment, these side effects are likely to diminish and eventually disappear.
                  </p>
                  <p className="text-gray-700 mb-4">
                    Establish a consistent injection schedule by administering Wegovy on the same day each week to give your body regular breaks between treatments. To effectively manage side effects, consider the following strategies:
                  </p>
                  <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <div className="bg-gray-50 rounded-lg">
              ...
              {expandedSection === 'storage' && (
                <div className="px-6 pb-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    After first use: Store below 30Â° C or, preferably, in a refrigerator (2Â° C to 8Â° C). Do not freeze wegovy and do not use it if it has been frozen. Keep the pen cap on when the pen is not in use in order to protect it from light.
                  </p>
                  <p className="text-gray-700 mb-4">
            ...
            <div className="bg-gray-50 rounded-lg">
              <button
                ...
                className="w-full flex items-center justify-between p-6 text-left"
              >
                <span className="text-lg font-semibold text-gray-900">Have Questions?</span>
                <span className="text-2xl text-gray-600">{expandedSection === 'questions' ? '−' : '+'}</span>
              </button>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                      <form className="space-y-4">
                        ...
                        <div>
                          <label htmlFor="subject" className="text-gray-700 block mb-2">Subject</label>
                          <input
                            type="text"
                            id="subject"
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        ...
                        <div>
                          <label htmlFor="message" className="text-gray-700 block mb-2">Your Message</label>
                          <textarea
                            id="message"
                            rows={4}
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <div className="flex justify-center">
                        <Image
                          src="/Homepage/header-logo-full.png"
                          alt="Assured Pharmacy Logo"
                          width={400}
                          height={200}
                          className="object-contain"
