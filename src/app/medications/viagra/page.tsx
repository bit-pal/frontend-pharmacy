...
export default function ViagraProductPage() {
  ...
  const strengths = [
    { value: '25mg', label: 'Viagra' },
    { value: '50mg', label: 'Viagra' },
    { value: '100mg', label: 'Viagra' }
  ];

  const quantities = [
    { value: '4 tablets', price: '£32.50', pricePerTablet: '£8.12' },
    { value: '8 tablets', price: '£62.00', pricePerTablet: '£7.75' },
    { value: '12 tablets', price: '£90.00', pricePerTablet: '£7.50' }
  ];
      ...
      <div className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8">
            {/* Left - Product Image */}
            <div className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl p-8 flex flex-col items-center justify-center relative">
              {/* Brand Badge */}
              <div className="absolute top-6 right-6">
                <div className="bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-bold flex items-center shadow-md">
                  <span>Original Blue Pill</span>
                </div>
              </div>
              ...
              <div className="mt-8 text-center">
                <h1 className="text-3xl font-bold text-gray-900 mb-4">Viagra erectile dysfunction treatment</h1>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-8">
                    ...
                    <button
                      ...
                      className={`px-4 py-3 rounded-lg border text-sm font-medium transition-colors ${
                        selectedStrength === strength.value
                          ? 'bg-blue-100 border-blue-700 text-gray-900'
              ...
              {/* Price */}
              <div className="mb-6">
                <div className="text-3xl font-bold text-blue-700 mb-1">{getCurrentPrice().price}</div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-gray-200">
                ...
                <div>
                  ...
                  <p className="font-bold text-gray-900">From £8.12</p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-lg">
              ...
              >
                <span className="text-lg font-semibold text-gray-900">What is Viagra and how does it work?</span>
              ...
              {expandedSection === 'what' && (
                <div className="px-6 pb-6">
                  ...
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    <li>The original and most well-known ED treatment</li>
                    <li>Proven track record of safety and effectiveness</li>
                    <li>Works in 30-60 minutes</li>
                    <li>Effective for 4-6 hours</li>
                  </ul>
                  <p className="text-gray-700">
                    Viagra is the branded version of sildenafil. While it works exactly the same as generic sildenafil, many men prefer the reassurance of the original brand name.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-gray-50 rounded-lg">
              <button
                ...
                className="w-full flex items-center justify-between p-6 text-left"
              >
                <span className="text-lg font-semibold text-gray-900">How to use Viagra</span>
              ...
              {expandedSection === 'using' && (
                <div className="px-6 pb-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Do not take more than one dose in 24 hours. If you have taken too much Viagra, contact your doctor or local hospital immediately.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-gray-50 rounded-lg">
              ...
              {expandedSection === 'side' && (
                <div className="px-6 pb-6">
                  <p className="text-gray-700 mb-4">
                    Like all medicines, Viagra can cause side effects, although not everyone gets them. Common side effects include:
                  </p>
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    <li>Headache</li>
