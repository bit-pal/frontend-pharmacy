...
export default function TadalafilProductPage() {
  ...
  const strengths = [
    { value: '10mg', label: 'Tadalafil' },
    { value: '20mg', label: 'Tadalafil' }
  ];

  const quantities = [
    { value: '4 tablets', price: '£9.00', pricePerTablet: '£2.25' },
    { value: '8 tablets', price: '£17.00', pricePerTablet: '£2.13' },
    { value: '16 tablets', price: '£32.00', pricePerTablet: '£2.00' }
  ];
      ...
      <div className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8">
            {/* Left - Product Image */}
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl p-8 flex flex-col items-center justify-center relative">
              {/* Longest Acting Badge */}
              <div className="absolute top-6 right-6">
                <div className="bg-teal-600 text-white px-4 py-2 rounded-lg text-sm font-bold flex items-center shadow-md">
                  <span>Longest Acting</span>
                </div>
              </div>
              ...
              <div className="mt-8 text-center">
                <h1 className="text-3xl font-bold text-gray-900 mb-4">Tadalafil erectile dysfunction treatment</h1>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-8">
              ...
              {/* Price */}
              <div className="mb-6">
                <div className="text-3xl font-bold text-teal-600 mb-1">{getCurrentPrice().price}</div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-gray-200">
                <div>
                  ...
                  <p className="font-bold text-gray-900">Up to 36 hours</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 mb-1">Works within</p>
                  <p className="font-bold text-gray-900">30-120 minutes</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 mb-1">Price from</p>
                  <p className="font-bold text-gray-900">£2.25 per tablet</p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-lg">
              ...
              >
                <span className="text-lg font-semibold text-gray-900">What is Tadalafil and how does it work?</span>
              ...
              {expandedSection === 'what' && (
                <div className="px-6 pb-6">
                  ...
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    <li>Longest acting ED treatment - up to 36 hours</li>
                    <li>Allows for more spontaneous sex</li>
                    <li>Not affected by food or alcohol (in moderation)</li>
            ...
            <div className="bg-gray-50 rounded-lg">
              <button
                ...
                className="w-full flex items-center justify-between p-6 text-left"
              >
                <span className="text-lg font-semibold text-gray-900">How to use Tadalafil</span>
                <span className="text-2xl text-gray-600">{expandedSection === 'using' ? '−' : '+'}</span>
              </button>
              {expandedSection === 'using' && (
                <div className="px-6 pb-6">
                  <p className="text-gray-700 mb-4">
                    Take one tablet at least 30 minutes before you plan to have sex. Tadalafil can remain effective for up to 36 hours. The recommended starting dose is 10mg, but this can be adjusted by your doctor.
                  </p>
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                  ...
                  <p className="text-gray-700 mb-4">
                    Do not take more than one dose in 24 hours. If you have taken too much Tadalafil, contact your doctor or local hospital immediately.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-gray-50 rounded-lg">
              ...
              {expandedSection === 'side' && (
                <div className="px-6 pb-6">
                  <p className="text-gray-700 mb-4">
                    Like all medicines, Tadalafil can cause side effects, although not everyone gets them. Common side effects include:
                  </p>
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    <li>Headache</li>
            ...
            <div className="bg-gray-50 rounded-lg">
              ...
              {expandedSection === 'who' && (
                <div className="px-6 pb-6">
                  <p className="text-gray-700 mb-4">
                    Tadalafil is not suitable for everyone. Do not take Tadalafil if you:
                  </p>
                  <ul className="list-disc pl-6 space-y-2 mb-4">
